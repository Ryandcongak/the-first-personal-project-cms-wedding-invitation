...
$id = $_GET['id'];
$query = query("SELECT * FROM users WHERE id = $id")[0];
                            ...
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <form action="" method="post">
                                        <input class="form-control" type="text" name="id" id="id" value="<?php echo $query['id']; ?>" hidden>
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            <td class="px-4 py-3">
                                                <div class="flex items-center text-sm">
                                                    <div>
                                                        <p class="font-semibold"><?php echo $query['username']; ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <?php echo $query['atas_nama']; ?>
                                            </td>
                                            <td class="px-4 py-3">
                                                <div class="flex items-center text-sm">
                                                    <!-- Avatar with inset shadow -->
                                                    <a href="assets/img/Bank_Transfer/<?php echo $query['ss_transfer']; ?>">
                                                        <div class="relative w-12 h-12 mr-3 rounded-full md:block">
                                                            <img class="object-cover w-full h-full" src="assets/img/Bank_Transfer/<?php echo $query['ss_transfer']; ?>" alt="" loading="lazy" />
                                            ...
                                            <td class="px-4 py-3 text-xs">
                                                <select name="aksi" class=" form-select block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" aria-label="Default select example" width="20px">
                                                    <option selected><?php
                                                                        $status = $query['aksi'];
                                                                        if ($status == "1") {
                                                                            echo "Approve";
                                            ...
                                            <td class="px-4 py-3 text-xs">
                                                <select name="tingkat" class=" form-select block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" aria-label="Default select example" width="20px">
                                                    <option selected><?php
                                                                        $category = $query['tingkat'];
                                                                        if ($category == "1") {
                                                                            echo "Admin";
                                                                        } else {
                                                                            echo "Client";
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex items-center space-x-4 text-sm">
                                                    <button type="submit" name="submit" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray " aria-label="Save">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                                                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
                                                        </svg>
                                                    </button>
                                                    <a href="aksi.php">
                                                        <button class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="cancel">

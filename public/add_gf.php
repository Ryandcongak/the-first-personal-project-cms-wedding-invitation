...
if (isset($_POST["submit"])) {
  ...
  if (create_galleries_foto($_POST) > 0) {
    echo "<script>
              ...
              <div class="w-full overflow-x-auto">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                  <label class="block mt-4 text-sm">
                    <input type="file" name="foto" id="foto" class="px-4 py-2 mt-2 mb-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">
                  </label>
                  <p class="mb-8 text-gray-600 dark:text-gray-400"><b>Note:</b>
                    <br>* Maksimal size 1 Mb.
                    <br>* Extension file JPG, JPEG or PNG.
                  </p>

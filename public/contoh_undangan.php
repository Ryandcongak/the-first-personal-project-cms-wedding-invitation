...
$query = query("SELECT * FROM contoh");
?>
<!DOCTYPE html>
                        ...
                        <div class="w-full overflow-x-auto">
                            <form action="" method="post">
                                <label class="block mt-4 text-sm">
                                    ...
                                    <input type="text" name="url" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="<?php foreach ($query as $url) {
                                                                                                                                                                                                                                                                                            echo $url['url'];
                                                                                                                                                                                                                                                                                        } ?>" />
                                </label>
                                <label class="block mt-6 mb-6 mr-6 text-sm">
                                    ...
                                    <a href="edit_contoh.php?id=<?php foreach ($query as $url) {
                                                                    echo $url['id'];
                                                                } ?>" class="px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue" role="button">Edit
                                    </a>
                                </label>
                            </form>
                        </div>
